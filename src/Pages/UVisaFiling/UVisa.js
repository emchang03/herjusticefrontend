...
const UVisa  = () => {
    ...
    const timeline = [
      ...
      },
      {
        ...
        duration: "Around 1-3 months after the case is filed with USCIS"
      },
      {
        number: 3,
